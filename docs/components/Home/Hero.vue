<template>
    <div class="flex flex-col items-center justify-center px-4 lg:px-0 pt-8 lg:pt-24 pb-16 max-w-screen-lg mx-auto">
        ...
        <div class="flex items-center justify-center mt-12 mb-16">
            ...
            <NuxtLink to="/docs" class="ml-3 bg-[#155EEF] py-3 px-5 font-sans font-semibold text-white flex items-center border-2 border-[rgba(255,255,255,0.12)] rounded-lg hover:bg-[#004EEB] transition-colors duration-200">
                Get Started
            </NuxtLink>
        </div>
