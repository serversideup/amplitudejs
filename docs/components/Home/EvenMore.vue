<template>
    <div class="w-full bg-[#0C0E12] py-24">
        <div class="max-w-screen-xl mx-auto px-8 flex flex-col items-center justify-center">
            <p class="font-semibold text-[#CECFD2] font-sans text-base">Features</p>
            <h2 class="mt-3 font-sans font-semibold text-4xl text-[#F7F7F7]">There's even more.</h2>
            <p class="mt-5 font-sans text-[#94979C] text-lg">AmplitudeJS is open source and freely available on Github.</p>
        </div>
