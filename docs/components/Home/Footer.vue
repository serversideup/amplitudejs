<template>
    <footer class="bg-[#0C0E12] w-full flex flex-col items-center justify-center pt-16">
        <div class="max-w-screen-xl w-full px-8 flex flex-col items-center justify-center border-b border-[#22262F] pb-16">
            <img src="/images/logos/amplitudejs.svg" alt="AmplitudeJS" class="h-8 mb-12"/>

            <div class="flex flex-col items-center justify-center mx-auto max-w-screen-md">
                <p class="text-center font-sans text-[#F7F7F7] font-semibold text-3xl">Take control of your audio experience.</p>
                <p class="mt-4 text-center font-sans text-[#94979C] text-xl">Free and Open Source on GitHub.</p>
                ...
                <div class="flex items-center justify-center mt-12">
                    ...
                    <NuxtLink to="/" class="ml-3 bg-[#155EEF] py-3 px-5 font-sans font-semibold text-white flex items-center border-2 border-[rgba(255,255,255,0.12)] rounded-lg hover:bg-[#004EEB] transition-colors duration-200">
                        Get Started
                    </NuxtLink>
                </div>
            </div>
        </div>
        <div class="max-w-screen-xl w-full px-8 flex flex-col items-center justify-center pt-8 pb-12">
            <p class="text-[#94979C] font-sans text-base">Powered by</p>
            <NuxtLink to="https://serversideup.net/" target="_blank" class="flex items-center">
                <img src="/images/logos/grey-server-side-up-logo.svg" alt="Server Side Up" class="h-12 mt-6"/>
            </NuxtLink>
        </div>
    </footer>
</template>