...
test('AmplitudeJS Goes To the Next Song In The Shuffle List In Playlist', () => {
  ...
  expect( config.playlists['trip_hop'].active_index ).toBe(1);
  expect( config.active_metadata ).toBe( config.playlists['trip_hop'].shuffle_list[1] );
});
...
test('AmplitudeJS Goes To the Previous Song In The Shuffle List', () => {
  ...
  expect( config.active_index ).toBe( config.songs.length - 1 );
  expect( config.active_metadata ).toBe( config.shuffle_list[ config.shuffle_list.length - 1] );
});
...
test('AmplitudeJS Goes To the Previous Song In Playlist', () => {
  ...
  expect( config.playlists['trip_hop'].active_index ).toBe( config.playlists['trip_hop'].songs.length - 1 );
  expect( config.active_metadata ).toBe( config.playlists['trip_hop'].songs[ config.playlists['trip_hop'].songs.length - 1 ] );
});
...
test('AmplitudeJS Goes To the Previous Song In The Shuffle List In Playlist', () => {
  ...
  expect( config.playlists['trip_hop'].active_index ).toBe( config.playlists['trip_hop'].shuffle_list.length -1 );
  expect( config.active_metadata ).toBe( config.playlists['trip_hop'].shuffle_list[ config.playlists['trip_hop'].shuffle_list.length -1 ] );
});
