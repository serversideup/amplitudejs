...
test('AmplitudeJS Play Pause Buttons Get Proper Classes After Global Clicked', () => {
  ...
  expect( document.getElementById('global-play-pause').classList.contains('amplitude-playing') ).toBe(true);
  expect( document.getElementById('playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-zero-play-pause').classList.contains('amplitude-playing') ).toBe(true);
  expect( document.getElementById('song-in-playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);

  document.getElementById('global-play-pause').click();

  expect( document.getElementById('global-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-zero-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-in-playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);
});
...
test('AmplitudeJS Play Pause Buttons Get Proper Classes After Playlist Clicked', () => {
  ...
  expect( document.getElementById('global-play-pause').classList.contains('amplitude-playing') ).toBe(true);
  expect( document.getElementById('playlist-play-pause').classList.contains('amplitude-playing') ).toBe(true);
  expect( document.getElementById('song-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-zero-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-in-playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);
...
test('AmplitudeJS Play Pause Buttons Get Proper Classes After Song Clicked', () => {
  ...
  expect( document.getElementById('global-play-pause').classList.contains('amplitude-playing') ).toBe(true);
  expect( document.getElementById('playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-play-pause').classList.contains('amplitude-playing') ).toBe(true);
  expect( document.getElementById('song-zero-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-in-playlist-play-pause').classList.contains('amplitude-paused') ).toBe(true);
...
test('AmplitudeJS Play Pause Buttons Get Proper Classes After Song In Playlist Clicked', () => {
  ...
  expect( document.getElementById('song-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-zero-play-pause').classList.contains('amplitude-paused') ).toBe(true);
  expect( document.getElementById('song-in-playlist-play-pause').classList.contains('amplitude-playing') ).toBe(true);
