...
test('AmplitudeJS Repeat Elements Get Proper Classes With Global Click', () => {
  ...
  expect( document.getElementById('global-repeat').classList.contains('amplitude-repeat-on') ).toBe(true);
  expect( document.getElementById('playlist-repeat').classList.contains('amplitude-repeat-on') ).toBe(true);

  document.getElementById('global-repeat').click();

  expect( config.repeat ).toBe( false );
  expect( document.getElementById('global-repeat').classList.contains('amplitude-repeat-on') ).toBe(false);
  expect( document.getElementById('playlist-repeat').classList.contains('amplitude-repeat-on') ).toBe(false);
});
...
test('AmplitudeJS Repeat Elements Get Proper Classes With Playlist Click', () => {
  ...
  expect( document.getElementById('global-repeat').classList.contains('amplitude-repeat-off') ).toBe(true);
  expect( document.getElementById('playlist-repeat').classList.contains('amplitude-repeat-on') ).toBe(true);
  ...
  expect( document.getElementById('global-repeat').classList.contains('amplitude-repeat-off') ).toBe(true);
  expect( document.getElementById('playlist-repeat').classList.contains('amplitude-repeat-off') ).toBe(true);
});
...
test('AmplitudeJS Repeat Song Elements Get Proper Classes With Click', () => {
  ...
  expect( document.getElementById('global-repeat-song').classList.contains('amplitude-repeat-song-on') ).toBe(true);

  document.getElementById('global-repeat-song').click();
  
  expect( config.repeat_song ).toBe( false );
  expect( document.getElementById('global-repeat-song').classList.contains('amplitude-repeat-song-off') ).toBe(true);
});
