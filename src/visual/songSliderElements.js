...
let SongSliderElements = (function(){
  ...
  /**
	...
	function syncPlaylist( location, playlist ){
		...
		*/
		const playlistSongSliders = document.querySelectorAll('.amplitude-song-slider[data-amplitude-playlist="'+playlist+'"]');
		...
		*/
        ...
        Grab the playlist and song attributes from the element.
      */
      let playlistAttribute = playlistSongSliders[i].getAttribute( 'data-amplitude-playlist' );
      let songAttribute = playlistSongSliders[i].getAttribute( 'data-amplitude-song-index' );
  ...
  /**
	...
	function syncSong( location, songIndex){
		...
		*/
		if( config.active_playlist == null ){
			...
			*/
			const songSliders = document.querySelectorAll('.amplitude-song-slider[data-amplitude-song-index="'+songIndex+'"]');
			...
			*/
	        ...
	        Grab the playlist and song attributes from the element.
	      */
	      let playlistAttribute = songSliders[i].getAttribute( 'data-amplitude-playlist' );
	      let songAttribute = songSliders[i].getAttribute( 'data-amplitude-song-index' );
	...
	function syncSongInPlaylist( location, playlist ){
		...
		*/
		const songInPlaylistSliders = document.querySelectorAll('.amplitude-song-slider[data-amplitude-playlist="'+playlist+'"][data-amplitude-song-index="'+activePlaylistIndex+'"]');
