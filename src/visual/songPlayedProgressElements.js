	...
	function syncGlobal( percentage ){
		...
		*/
		if( !isNaN( percentage ) ){
			...
			*/
			let songPlayedProgressBars = document.querySelectorAll('.amplitude-song-played-progress');

			for( let i = 0; i < songPlayedProgressBars.length; i++ ){
				let playlist = songPlayedProgressBars[i].getAttribute('data-amplitude-playlist');
				let songIndex = songPlayedProgressBars[i].getAttribute('data-amplitude-song-index');
		...
		*/
		if( !isNaN( percentage ) ){
			/*
				Get all of the song progress bars
			*/
			let songPlayedProgressBars = document.querySelectorAll('.amplitude-song-played-progress[data-amplitude-playlist="'+config.active_playlist+'"]');

			for( let i = 0; i < songPlayedProgressBars.length; i++ ){
				let song = songPlayedProgressBars[i].getAttribute( 'data-amplitude-song-index' );
			...
			*/
			if( !isNaN( percentage ) ){
				/*
					Get all of the song progress bars
				*/
				let songPlayedProgressBars = document.querySelectorAll('.amplitude-song-played-progress[data-amplitude-song-index="'+config.active_index+'"]');
		...
		*/
		if( !isNaN( percentage ) ){
			...
			/*
				Get all of the song progress bars
			*/
			let songPlayedProgressBars = document.querySelectorAll('.amplitude-song-played-progress[data-amplitude-playlist="'+config.active_playlist+'"][data-amplitude-song-index="'+activePlaylistIndex+'"]');
