...
let DurationTimeElements = (function(){
  ...
  function syncGlobal( durationText ){
    let durationTimeSelectors = document.querySelectorAll( '.amplitude-duration-time' );

    for( let i = 0; i < durationTimeSelectors.length; i++ ){
      let playlist = durationTimeSelectors[i].getAttribute('data-amplitude-playlist');
			let songIndex = durationTimeSelectors[i].getAttribute('data-amplitude-song-index');
  ...
  function syncPlaylist( durationText ){
    let durationTimeSelectors = document.querySelectorAll( '.amplitude-duration-time[data-amplitude-playlist="'+config.active_playlist+'"]' );
  ...
  function syncSong( durationText ){
    if( config.active_playlist == null ){
      let durationTimeSelectors = document.querySelectorAll( '.amplitude-duration-time[data-amplitude-song-index="'+config.active_index+'"]' );
  ...
  function syncSongInPlaylist( durationText ){
    ...
    let durationTimeSelectors = document.querySelectorAll( '.amplitude-duration-time[data-amplitude-playlist="'+config.active_playlist+'"][data-amplitude-song-index="'+activePlaylistIndex+'"]' );
