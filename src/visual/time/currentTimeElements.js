...
let CurrentTimeElements = (function(){
  ...
  function syncGlobal( time ){
		...
		*/
		let currentTimeSelectors = document.querySelectorAll( '.amplitude-current-time' );
      ...
      let playlist = currentTimeSelectors[i].getAttribute('data-amplitude-playlist');
      let songIndex = currentTimeSelectors[i].getAttribute('data-amplitude-song-index');
  ...
  function syncPlaylist( time ){
		...
		/*
			Get all of the time selectors.
		*/
		let currentTimeSelectors = document.querySelectorAll( '.amplitude-current-time[data-amplitude-playlist="'+config.active_playlist+'"]' );
  ...
  function syncSong( time ){
    if( config.active_playlist == null ){
  		...
  		/*
  			Get all of the time selectors.
  		*/
  		let currentTimeSelectors = document.querySelectorAll( '.amplitude-current-time[data-amplitude-song-index="'+config.active_index+'"]' );
  ...
  function syncSongInPlaylist( time ){
    ...
    let activePlaylistIndex = config.active_playlist != '' && config.active_playlist != null ? config.playlists[ config.active_playlist ].active_index : null;
		/*
			Get all of the time selectors.
		*/
		let currentTimeSelectors = document.querySelectorAll( '.amplitude-current-time[data-amplitude-playlist="'+config.active_playlist+'"][data-amplitude-song-index="'+activePlaylistIndex+'"]' );
