...
let PlayPauseElements = (function(){
  ...
  function syncGlobal(){
    ...
    */
    const playPauseElements = document.querySelectorAll('.amplitude-play-pause');
    ...
    */
    for( let i = 0; i < playPauseElements.length; i++ ){
      ...
      */
      let playlist = playPauseElements[i].getAttribute( 'data-amplitude-playlist' );
  ...
  function syncPlaylist(){
    ...
    */
    const playlistPlayPauseElements = document.querySelectorAll('.amplitude-play-pause[data-amplitude-playlist="'+config.active_playlist+'"]');
    ...
    */
    for( let i = 0; i < playlistPlayPauseElements.length; i++ ){
      ...
      */
      let song = playlistPlayPauseElements[i].getAttribute( 'data-amplitude-song-index' );
  ...
  function syncSong(){
    ...
    */
    let songPlayPauseElements = document.querySelectorAll('.amplitude-play-pause[data-amplitude-song-index="'+config.active_index+'"]');
    ...
    */
    for( let i = 0; i < songPlayPauseElements.length; i++ ){
      ...
      */
      let playlist = songPlayPauseElements[i].getAttribute( 'data-amplitude-playlist' );
  ...
  function syncSongInPlaylist(){
    ...
    */
    let songInPlaylistPlayPauseElements = document.querySelectorAll('.amplitude-play-pause[data-amplitude-song-index="'+activePlaylistIndex+'"][data-amplitude-playlist="'+config.active_playlist+'"]');
