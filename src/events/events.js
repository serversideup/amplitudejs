...
let AmplitudeEvents = (function () {
	...
	function initializeEvents(){
		...
		*/
		AmplitudeCoreHelpers.writeDebugMessage( 'Beginning initialization of event handlers..' );
	...
	function bindKeyDownEventHandlers(){
		document.removeEventListener("keydown", AmplitudeHandlers.keydown );
	...
	function bindPlay(){
		...
		*/
		let play_classes = document.getElementsByClassName("amplitude-play");
		...
		*/
		for( let i = 0; i < play_classes.length; i++ ){
	...
	function bindPause(){
		...
		*/
		let pause_classes = document.getElementsByClassName("amplitude-pause");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < pause_classes.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	function bindPlayPause(){
		...
		*/
		let play_pause_classes = document.getElementsByClassName("amplitude-play-pause");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < play_pause_classes.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	function bindStop(){
		...
		*/
		let stop_classes = document.getElementsByClassName("amplitude-stop");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < stop_classes.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	function bindMute(){
		...
		*/
		let mute_classes = document.getElementsByClassName("amplitude-mute");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < mute_classes.length; i++ ){
			/*
			...
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
				...
				*/
				if( /iPhone|iPad|iPod/i.test(navigator.userAgent) ) {
					AmplitudeCoreHelpers.writeDebugMessage( 'iOS does NOT allow volume to be set through javascript: https://developer.apple.com/library/safari/documentation/AudioVideo/Conceptual/Using_HTML5_Audio_Video/Device-SpecificConsiderations/Device-SpecificConsiderations.html#//apple_ref/doc/uid/TP40009523-CH5-SW4' );
				}else{
	...
	function bindVolumeUp(){
		...
		*/
		let volume_up_classes = document.getElementsByClassName("amplitude-volume-up");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < volume_up_classes.length; i++ ){
			/*
				WARNING: If iOS, we don't do anything because iOS does not allow the
				volume to be adjusted through anything except the buttons on the side of
				the device.
	...
	function bindVolumeDown(){
		...
		*/
		let volume_down_classes = document.getElementsByClassName("amplitude-volume-down");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < volume_down_classes.length; i++ ){
			/*
				WARNING: If iOS, we don't do anything because iOS does not allow the
				volume to be adjusted through anything except the buttons on the side of
				the device.
    ...
    let msie 	= ua.indexOf("MSIE ");
		...
		*/
		let song_sliders = document.getElementsByClassName("amplitude-song-slider");
		...
		*/
		for( let i = 0; i < song_sliders.length; i++ ){
    ...
    */
		let volume_sliders = document.getElementsByClassName("amplitude-volume-slider");
		...
		/*
			...
			where if it is anything else, it's the input method.
		*/
		for( let i = 0; i < volume_sliders.length; i++ ){
			/*
				WARNING: If iOS, we don't do anything because iOS does not allow the
				volume to be adjusted through anything except the buttons on the side of
				the device.
    ...
    */
		let next_classes = document.getElementsByClassName("amplitude-next");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < next_classes.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	function bindPrev(){
		...
		*/
		let prev_classes = document.getElementsByClassName("amplitude-prev");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < prev_classes.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	function bindShuffle(){
		...
		*/
		let shuffle_classes = document.getElementsByClassName("amplitude-shuffle");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < shuffle_classes.length; i++ ){
			/*
	...
	function bindRepeat(){
		...
		*/
		let repeat_classes = document.getElementsByClassName("amplitude-repeat");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < repeat_classes.length; i++ ){
			/*
				Since we are re-binding everything we remove any classes that signify
	...
	function bindPlaybackSpeed(){
		...
		*/
		let playback_speed_classes = document.getElementsByClassName("amplitude-playback-speed");
		...
		/*
			...
			otherwise it is click.
		*/
		for( let i = 0; i < playback_speed_classes.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	...
	function bindSkipTo(){
		...
		*/
		let skipToClasses = document.getElementsByClassName("amplitude-skip-to");
		...
		*/
		for( let i = 0; i < skipToClasses.length; i++ ){
			if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
